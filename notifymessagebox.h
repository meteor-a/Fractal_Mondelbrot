...
public:
    ...
    explicit NotifyMessageBox(const QString& text, int milliseconds, QWidget* parent = nullptr);
...
public:
    ...
    static void showMessage(const QString& message, int milliseconds, QWidget* parent);
